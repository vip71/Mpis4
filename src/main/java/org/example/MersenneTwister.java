 ...
 *
 * <p><b>MersenneTwisterFast</b> is not a subclass of java.util.Random. It
 has
 ...
 * <i>Important note:</i> Do not MersenneTwister.java or java.util.Random on
 a Java version this early! Random number generation in versions less than
 1.1.5 has serious bugs.
 * </dl>
 *
 @version 3
 */
 ...
 */
 ...
 /*
 r = new MersenneTwister(4357);
 System.out.println("Output of MersenneTwister with new (1999/10/28)
seeding mechanism");
 for (j=0;j<1000;j++)
 {
 // first, convert the int from signed to "unsigned"
